...
class NormalWidget(QWidget):
   ...
   #userId, Technique, density, taille, tempsClick, nbErrors, n°target 
    ...
    def mousePressEvent(self,event):
        targeted = self.cursor.targeted
        if (targeted != None and targeted.toSelect):
            targeted.toSelect = False
